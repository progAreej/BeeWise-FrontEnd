...
//           <div>
//             <img className="mx-auto h-12 w-auto" src="/src/assets/imgs/logo.png" alt="BeeWise logo" />
...
//                 <input id="email-address" name="email" type="email" autoComplete="email" required className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-goldD focus:border-goldD focus:z-10 sm:text-sm" placeholder="Email address" />
//               </div>
//               <div>
//                 <label htmlFor="password" className="sr-only">Password</label>
//                 <input id="password" name="password" type="password" autoComplete="current-password" required className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-goldD focus:border-goldD focus:z-10 sm:text-sm" placeholder="Password" />
//               </div>
//             </div>

//             <div className="flex items-center justify-between">
//               <div className="flex items-center">
//                 <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 text-goldD focus:ring-goldD border-gray-300 rounded" />
...
//             <div>
//               <button type="submit" className="w-full bg-goldD hover:bg-goldL text-white font-bold py-2 px-4 rounded-md focus:outline-none focus:ring-goldD focus:border-goldD">
//                 Log In
//               </button>
//             </div>
//           </form>
  ...
  const handleSubmit = (e) => {
    ...
    if (storedUser) {
      ...
      if (email === storedUser.email && password) {
        // You might want to set some authentication status here
